context("Access signin/signup", () => {
  ...
  it("signin success", () => {
    ...
    cy.get("input#username.ant-input").type("cyTester1");
    cy.get("input#password.ant-input").type("12345678");
    ...
    cy.contains(
      ...
      "Successfully signed in! Welcome cyTester1!"
    );
  });
  ...
  it("signin unsuccessful", () => {
    ...
    cy.get("input#username.ant-input").type("cyTester0");
    cy.get("input#password.ant-input").type("12345678");
